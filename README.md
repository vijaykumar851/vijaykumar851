...
| Project | Description |
|---------|-------------|
| 🚗 Car Pooling Platform | Full Stack ride-sharing application built using Spring Boot & React |
| 🚚 Transport Management System | Transport scheduling and management application |
| 📊 Power BI Dashboard | Interactive business analytics dashboard |
